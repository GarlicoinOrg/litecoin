...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/garlicoin-project/garlicoin>";
    ...
    while (!fLoaded && !fRequestShutdown) {
        ...
        do {
            try {
                ...
                CValidationState state;
                if (!ReplayBlocks(state, chainparams, pcoinsdbview)) {
