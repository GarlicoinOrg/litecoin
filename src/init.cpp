...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/honeycomb-project/honeycomb>";
    const std::string URL_WEBSITE = "<https://honeycomb.io>";
